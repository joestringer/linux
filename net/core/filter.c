...
BPF_CALL_3(bpf_skb_set_socket, struct sk_buff *, skb, struct sock *, sk, u64, flags)
{
...
static const struct bpf_func_proto bpf_skb_set_socket_proto = {
	.func		= bpf_skb_set_socket,
	.gpl_only	= false,
	.ret_type	= RET_INTEGER,
	.arg1_type      = ARG_PTR_TO_CTX,
...
tc_cls_act_func_proto(enum bpf_func_id func_id, const struct bpf_prog *prog)
{
	...
	case BPF_FUNC_skb_ecn_set_ce:
		return &bpf_skb_ecn_set_ce_proto;
	case BPF_FUNC_skb_set_socket:
		return &bpf_skb_set_socket_proto;
#endif
	default:
		return bpf_base_func_proto(func_id);
	}
