...
static struct bpf_test tests[] = {
	...
	},
	{
		...
		.prog_type = BPF_PROG_TYPE_SCHED_CLS,
		.errstr = "may hold unreleased reference",
		.result = REJECT,
	},
	{
	...
	},
	{
		...
		.prog_type = BPF_PROG_TYPE_SCHED_CLS,
		.errstr = "overwriting unchecked reference in R0",
		.result = REJECT,
	},
	{
		...
		.prog_type = BPF_PROG_TYPE_SCHED_CLS,
		.errstr = "overwriting unchecked reference in R7",
		.result = REJECT,
	},
	{
	...
	},
	{
		...
		.prog_type = BPF_PROG_TYPE_SCHED_CLS,
		.errstr = "R1 may hold unreleased reference",
		.result = REJECT,
	},
	{
		...
		.prog_type = BPF_PROG_TYPE_SCHED_CLS,
		.retval = POINTER_VALUE, /* XXX: What does this mean? */
		.result = ACCEPT,
	},
	{
		...
		.prog_type = BPF_PROG_TYPE_SCHED_CLS,
		.errstr = "stack[0] may hold unreleased reference",
		.result = REJECT,
	},
	{
